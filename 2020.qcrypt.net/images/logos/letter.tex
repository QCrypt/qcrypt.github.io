...
\def\Where{Centrum Wiskunde en Informatica} % Your department/institution
\def\Address{Amsterdam, Netherlands} % Your address
\def\Email{esteban@cwi.nl} % Your email address
\def\URL{2020.qcrypt.net} % Your URL
...
\address{\vspace*{-5.3cm}
  \includegraphics[width=2in]{QCr_Logo_black.png} %Include the logo of your institution
